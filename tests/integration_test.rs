...
mod tests {
    ...
    fn default_config() {
        ...
        assert_eq!("$argon2i$v=19$m=65536,t=2,p=4$c29tZXNhbHQ$RdescudvJCsgt3ub+b+dWRWJTmaaJObG", out.0);
    }
    ...
    fn default_with_argon2id() {
        ...
        let out=config.start().unwrap();
        assert_eq!("$argon2id$v=19$m=65536,t=2,p=4$c29tZXNhbHQ$F1jG2CV3/Nr+yRuIsPKw0J9r4s7cJHBU", out.0);
    }
